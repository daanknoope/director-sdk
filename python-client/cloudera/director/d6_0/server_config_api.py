...
class ServerConfigApi(object):
    ...
    def metadata(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_call=True
        >>> thread = api.metadata(async_call=True)
        >>> result = thread.get()
    ...
    def metadata_with_http_info(self, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_call=True
        >>> thread = api.metadata_with_http_info(async_call=True)
        >>> result = thread.get()
    ...
    def update_configs(self, server_configs, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_call=True
        >>> thread = api.update_configs(server_configs, async_call=True)
        >>> result = thread.get()
    ...
    def update_configs_with_http_info(self, server_configs, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_call=True
        >>> thread = api.update_configs_with_http_info(server_configs, async_call=True)
        >>> result = thread.get()
